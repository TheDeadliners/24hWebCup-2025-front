...
async function forgot(forgotData) {
    try {
        const forgotResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/forgot-password`, forgotData, {
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json"
            }
...
async function reset(resetData) {
    try {
        const registerResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/reset-password`, resetData, {
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json"
            }
